...
export default function ServicesSection() {
  return (
    <section
      id="entrenamientos"
      className="relative z-[10] flex flex-col scroll-mt-8 rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px]"
    ...
    >
      <ImageCursorTrail
        ...
        className="min-h-[min(100vh,920px)] w-full px-5 py-20 sm:px-8 sm:py-24 md:px-10 md:py-32"
      >
