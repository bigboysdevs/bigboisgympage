...
export default function ServicesSection() {
  return (
    <section
      id="entrenamientos"
      className="flex flex-col scroll-mt-8 rounded-t-[40px] px-5 py-20 sm:rounded-t-[50px] sm:px-8 sm:py-24 md:rounded-t-[60px] md:px-10 md:py-32"
    ...
    >
      ...
      <div className="flex w-full flex-col items-center">
        {TRAINING_PLANS.map((service, i) => (
          ...
          >
            {i > 0 && (
              <div className="w-full" style={{ borderTop: '1px solid rgba(12, 12, 12, 0.15)' }} />
            )}
