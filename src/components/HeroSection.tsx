  ...
  return (
    ...
    >
      <div className="relative z-10 flex min-h-0 flex-1 flex-col px-5 sm:px-8 md:px-10 overflow-visible">
        <FadeIn delay={0.15} y={40} className="relative z-20 mt-2 sm:mt-2 md:mt-0">
          <h1
        ...
        {/* Figura a ancho completo, sin caja 56svh; puede solapar título y pie del hero */}
        ...
        <div className="relative z-10 -mt-6 flex justify-between items-end gap-4 pb-7 pt-2 sm:-mt-8 sm:pb-8 md:pb-10">
