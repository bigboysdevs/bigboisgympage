...
export default function FloatingRadioPlayer() {
  return (
    <div
      className="fixed bottom-5 right-4 z-[90] flex flex-row items-center gap-2 sm:bottom-8 sm:right-6"
      data-nocursor
    >
      <a
        ...
        className="pointer-events-auto shrink-0 rounded-full bg-[#0a0a0a]/90 px-3 py-1.5 text-[10px] font-medium uppercase tracking-[0.2em] text-white/60 ring-1 ring-white/10 backdrop-blur-sm transition-colors hover:text-[#ef4444] hover:ring-[#dc2626]/40"
      >
        Ibiza Global
      </a>
